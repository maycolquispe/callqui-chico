...
$sql = "SELECT sector, manzana, lote, area_m2, area_excedente_m2, estado, observacion FROM lotes WHERE usuario_id = ?"; 
    ...
    <div class="nav-bar">
        <div class="nav-container">
            ...
            <div class="nav-actions">
                <a href="../../perfil/perfil_ajax.php" class="btn-nav">
                                    ...
                                    <tr> 
                                        ...
                                        <td data-label="Observación">
                                            <?php if (!empty($row['observacion'])): ?>
                                                <span class="observacion-badge" title="<?= htmlspecialchars($row['observacion']) ?>">
                                                    <i class="bi bi-info-circle-fill"></i>
                                                    <?= htmlspecialchars(substr($row['observacion'], 0, 30)) ?><?= strlen($row['observacion']) > 30 ? '...' : '' ?>
                                                </span>
                                            <?php else: ?>
